...
void main()
{
 ...
 int n;
 printf("no. of ele.in set A:");
 scanf("%d",&n);
 readset(a,n);
 printf("no of ele. in set B:");
 scanf("%d",&n);
 readset(b,n);
...
//function to read set and store as bit string
...
// fuction to print a set from bit string representaion
